...
if __name__=="__main__":
    prompt = "[1250, 1380, 1120, 1450, 1620, 1580, 1700, 1850, 1680, 1520, 1400, 1300] represents the net income of a company from January to December 2025 (in units of ten thousand yuan). Analyze its seasonal fluctuation patterns and speculate on the potential business reasons behind the mid-year revenue peak (July-August) and year-end decline."
