############################################
import sys
sys.path.append("/hongbojiang/codes/VGU/Qwen-Image")
from qwen_imagegen import get_model, generate_image
############################################
import os, random
import pandas as pd
...
def main():
    ...
    ############################################
    output_dir = "/hongbojiang/workdirs/T2I_Render/Qwen-Image"
    ############################################
